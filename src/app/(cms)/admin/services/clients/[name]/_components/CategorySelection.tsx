...
import { getCategories } from '@/services/clients';
...
type CategorySelectionProps = {
  control: Control<z.infer<typeof clientSchema>>;
};
  ...
  return (
    <div className="bg-sidebar p-6 rounded-2xl border space-y-6">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-lg">Kategori Klien</h3>
      </div>
      <p className="text-sm text-muted-foreground">
        Pilih kategori yang sesuai untuk klien ini dari daftar Master Kategori.
      </p>
      ...
      {isLoadingCategories ? (
        ...
        <div className="text-center py-8 border border-dashed rounded-xl space-y-2">
          ...
          <Button variant="link" size="sm" asChild>
            <Link href="/admin/services/clients">Buat di Master Kategori</Link>
          </Button>
        </div>
      )}
    </div>
