...
const ImageUpload: FC<ImageUploadProps> = ({
  ...
  const handleImageChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      // Validasi Dimensi saja — rasio bebas (logo bisa square, landscape, maupun portrait)
      ...
      img.onload = () => {
        ...
        if (width < 100 || height < 100) {
          toast.error(`Ukuran logo terlalu kecil (${width}x${height}px). Minimal 100x100px.`);
  ...
  return (
    <Field>
      ...
      <p className="text-xs text-muted-foreground mt-2">
        Maksimal 5MB. Minimal 100x100px (Square, Landscape, maupun Portrait). Gambar akan dikompres
