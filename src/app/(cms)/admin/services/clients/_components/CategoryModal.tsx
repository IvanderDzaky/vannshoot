...
import { getCategories, createCategory, deleteCategory, updateCategory } from '@/services/clients';
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>Master Kategori Klien</DialogTitle>
          <DialogDescription>
            Kelola daftar kategori yang dapat digunakan oleh klien.
          </DialogDescription>
        </DialogHeader>

        <div className="space-y-6 pt-4">
          {hasPermission('client.category.create') && (
                ...
                >
                  ...
                  <div className="flex items-center gap-1">
                    {editingId === cat.id ? (
                      ...
                      <>
                        {hasPermission('client.category.update') && (
                          <Button
                            variant="ghost"
                            size="icon"
                        ...
                        {hasPermission('client.category.delete') && (
                          <Button
                            variant="ghost"
                            size="icon"
